...
function FloatingPaths({ position }: { position: number }) {
  ...
  return (
    <svg
      className="w-full h-full text-red-600 dark:text-red-600" style={{ filter: 'blur(20px)' }}
      viewBox="0 0 696 316"
      fill="none"
    >
      {paths.map((path) => (
...
export default function BackgroundPaths() {
  return (
    <div
      ...
      className="fixed inset-0 -z-10 overflow-hidden pointer-events-none blur-3xl"
    >
