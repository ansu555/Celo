...
const DEFAULT_MAINNET_TOKENS: Record<string, TokenInfo> = {
  ...
  CUSD: {
    symbol: "cUSD",
    address: (process.env.CELO_CUSD_ADDRESS_MAINNET ||
  ...
  CEUR: {
    symbol: "cEUR",
    address: (process.env.CELO_CEUR_ADDRESS_MAINNET ||
      "0xd8763cBa276a3738E6De85B4B3BF5FDed6d6cA73") as Address,
    decimals: 18,
    coingeckoId: "celo-euro",
  },
  CREAL: {
    symbol: "cREAL",
    address: (process.env.CELO_CREAL_ADDRESS_MAINNET ||
      "0xe4d517785D091D3c54818832dB6094bcc0EFc7A0") as Address,
    decimals: 18,
...
const DEFAULT_ALFAJORES_TOKENS: Record<string, TokenInfo> = {
  ...
  CUSD: {
    symbol: "cUSD",
    address: (process.env.CELO_CUSD_ADDRESS_ALFAJORES ||
...
const DEFAULT_SEPOLIA_TOKENS: Record<string, TokenInfo> = {
  ...
  CUSD: {
    symbol: "cUSD",
    address: (process.env.CELO_CUSD_ADDRESS_SEPOLIA ||
      "0x874069Fa1Eb16D44d622F2e0Ca25eeA172369bC1") as Address,
    decimals: 18,
    coingeckoId: "celo-dollar",
  },
  CEUR: {
    symbol: "cEUR",
    address: (process.env.CELO_CEUR_ADDRESS_SEPOLIA ||
      "0x10c892A6EC43a53E45D0B916B4b7D383B1b78C0F") as Address,
    decimals: 18,
    coingeckoId: "celo-euro",
  },
  TKA: {
    symbol: "TKA",
    address: (process.env.NEXT_PUBLIC_TEST_TOKEN_A ||
      "0x12846d5C14622d085B0bbD9033e87d08C59a67d1") as Address,
    decimals: 18,
  },
  TKB: {
    symbol: "TKB",
...
const DEFAULT_CHAIN_ID = Number(
  process.env.CHAIN_ID || process.env.NEXT_PUBLIC_CHAIN_ID || 11142220
);
